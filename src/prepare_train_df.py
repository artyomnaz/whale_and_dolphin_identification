...
if __name__ == "__main__":
    ...
    individual_mapping = train_df['individual_id'].value_counts().reset_index().drop(columns=['individual_id'])
    ...
    skf_splits = skf.split(X=train_df.drop(columns="individual_key"), y=train_df["individual_key"])
